...
Revision ID: ddf4039e294b
Revises: 
Create Date: 2020-01-17 21:28:46.294581
...
def upgrade():
    ...
    op.create_index(op.f('ix_word_category'), 'word', ['category'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_word_category'), table_name='word')
    op.drop_table('word')
